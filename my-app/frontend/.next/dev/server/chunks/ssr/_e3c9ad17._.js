module.exports = [
"[project]/app/adduser/components/postcrt.tsx [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

// i havent note this yet
 //import Getuserandpost ,{Crpost} from "@/app/actions/post";
}),
"[project]/app/actions/data:505e65 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/actions/data:747a7e [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$505e65__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:505e65 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$747a7e__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:747a7e [app-ssr] (ecmascript) <text/javascript>");
...
function Userreg() {
    ...
    const sub = async (e)=>{
        e.preventDefault();
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$505e65__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["default"])({
            name,
            userId
        });
        if (res.success) {
    ...
    const gt = async ()=>{
        const ft = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$747a7e__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["Bcgetuser"])();
        if (ft.success) {
            setUserlist(ft.data);
        } else {
...
//# sourceMappingURL=_e3c9ad17._.js.map