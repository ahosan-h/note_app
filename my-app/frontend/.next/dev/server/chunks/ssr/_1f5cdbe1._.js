...
;
;
async function Getuserandpost(username) {
    try {
        ...
        const [user, post] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$models$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["User"].findOne({
                userId: username
            }).lean(),
            __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$models$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Post"].find().populate("author", "name").sort({
                createdAt: -1
            }).lean()
        ]);
        if (!user) {
            return {
                success: false,
                error: "user not found for getting post"
            };
        }
        return {
            success: true,
        ...
        return {
            success: false,
            error: "error while parallel querying"
        };
    }
}
async function Crpost(data) {
    try {
        ...
        const createpost = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$models$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Post"].create({
            title: data.title,
        ...
        return {
            success: true,
            post: JSON.parse(JSON.stringify(createpost))
        };
    } catch (error) {
        console.error(error);
        return {
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(Getuserandpost, "406a5c36494fe6946691805eae92f577d169a6ad5f", null);
...
"[project]/.next-internal/server/app/adduser/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/actions/post.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/app/actions/server.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/adduser/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/actions/post.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/app/actions/server.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$adduser$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$app$2f$actions$2f$post$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$app$2f$actions$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/adduser/page/actions.js { ACTIONS_MODULE0 => "[project]/app/actions/post.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/app/actions/server.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$post$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/actions/post.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/actions/server.ts [app-rsc] (ecmascript)");
}),
];

//# sourceMappingURL=_1f5cdbe1._.js.map